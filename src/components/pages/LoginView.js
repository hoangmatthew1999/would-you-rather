...
const LoginFormWrapper = styled.div`
  ...
  -moz-box-shadow: 0 6px 8px 0 rgba(0, 0, 0, 0.7);
  -webkit-box-shadow: 0 6px 8px 0 rgba(0, 0, 0, 0.7);
...
class LoginView extends Component {
  ...
  handleSubmit = e => {
    ...
    this.props.dispatch(handleAuthUser(credentials));
  };
    ...
    return (
      <LoginWrapper>
        <LoginFormWrapper>
          ...
          <LoginForm id="login" onSubmit={this.handleSubmit}>
            <StyledInput
              placeholder="e-mail"
              required
              type="text"
...
export default connect(({ users }) => ({ users: users }))(LoginView);
